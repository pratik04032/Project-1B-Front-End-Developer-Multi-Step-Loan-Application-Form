...
// Add button
if (!content.includes('Export to Google Sheets')) {
  content = content.replace(
    ...
    `<div className="flex flex-wrap items-center gap-3 self-end md:self-auto">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white font-bold text-xs rounded-lg transition-colors cursor-pointer shadow-sm"
          >
            {isExporting ? (
