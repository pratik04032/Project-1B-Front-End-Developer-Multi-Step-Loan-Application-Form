...
// handleLogin
const hStart = content.indexOf('const handleLogin = (e: React.FormEvent) => {');
const hEnd = content.indexOf('}, 1000);\n  };') + '}, 1000);\n  };'.length;
...
content = content.substring(0, hStart) + newHandleLogin + content.substring(hEnd);
